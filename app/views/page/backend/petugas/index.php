        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                    ...
                    <a href="<?= BASE_URL ?>/petugas/create" class="btn btn-dark">Tambah <i data-feather="plus"></i></a>
                </h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($data['dataPetugas'] as $dp) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= BASE_URL ?>/petugas/edit/<?= $dp['id_petugas'] ?>" class="btn btn-warning"><i data-feather="edit"></i></a>
