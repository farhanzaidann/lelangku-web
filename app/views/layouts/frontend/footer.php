<footer class="text-center py-3">
    <div class="container">
        <span class="p-3">&copy; <?= date('Y') ?> Aplikasi Lelang Online (Lelangku) <br> Made with <i class="lni lni-heart"></i> by <a href="https://github.com/farhanzaidann" target="_blank" class="text-dark"><?= AUTHOR ?></a></span>
    </div>
</footer>
