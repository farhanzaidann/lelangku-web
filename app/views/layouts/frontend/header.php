...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="<?= BASE_URL ?>"><img src="<?= BASE_URL ?>/assets/images/logoo.svg" alt="" width="150"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php if (empty($_SESSION['user'])) : ?>
                    ...
                    <a href="<?= BASE_URL ?>/register" class="btn btn-outline-dark ms-2">Register</a>
                <?php else : ?>
                    <a href="<?= BASE_URL ?>/dashboard" class="btn btn-outline-dark">Dashboard</a>
                <?php endif; ?>
